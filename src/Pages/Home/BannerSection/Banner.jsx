        ...
        <div>
            <div className="pt-16 pb-16">
                ...
                <div className="banner-items flex flex-col-reverse lg:flex-row  justify-between items-center">
                    ...
                    <div className="banner-left md:w-full flex flex-col items-center lg:items-start">
                        ...
                        <div className="mt-4">
                            ...
                            <a href="https://drive.google.com/file/d/14A3e6eEx_cKXgZzxLlWd-GfMJo7zJvkh/view?usp=sharing"><button className='btn btn-secondary'>Download Resume</button></a>
